  ...
  return (
    <>
      ...
      <main className="flex flex-1 items-center px-6 pb-10 sm:px-10 lg:px-12">
        <div className="mx-auto grid w-full max-w-6xl gap-12 lg:grid-cols-[minmax(0,1.1fr)_28rem] lg:items-center">
            ...
            <div className="liquid-glass relative overflow-hidden rounded-[2rem] border border-white/14 bg-white/[0.06] p-7 shadow-[0_40px_120px_rgba(0,0,0,0.35)] sm:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex flex-col gap-3 text-sm text-white/60 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <a href="#" className="text-white/70 no-underline transition-colors hover:text-foreground">
                    Forgot password?
                  </a>
                </div>
                ...
                <button
                  type="submit"
                  className="inline-flex w-full items-center justify-center rounded-full border border-white/16 bg-white px-6 py-3.5 text-sm font-medium text-black shadow-[0_18px_44px_rgba(0,0,0,0.22)] transition-all duration-300 hover:translate-y-[-1px] hover:bg-white/92 focus:outline-none focus:ring-4 focus:ring-white/18"
                >
                  Sign in to GreenGauge
                </button>
              </form>

              <div className="mt-6 border-t border-white/10 pt-5 text-center text-sm text-white/54">
                Don&apos;t have an account?{' '}
                <a href="#" className="text-white/76 no-underline transition-colors hover:text-foreground">
                  Request access
                </a>
              </div>
            </div>
