  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      {messages.length === 0 ? (
        ...
        <section className="verdant-scrollbar mx-auto flex min-h-0 w-full max-w-[78rem] flex-1 flex-col gap-5 overflow-y-auto px-6 pb-4 pt-6">
          {messages.map((msg) =>
            msg.role === 'user' ? (
      ...
      <div className="z-10 w-full px-6 pb-6 pt-4">
        <div className="verdant-glass mx-auto flex w-full max-w-[78rem] items-center gap-3 rounded-[1.6rem] px-4 py-4 sm:px-5">
          <button
            type="button"
